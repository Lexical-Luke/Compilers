...
public class Parser {
	...
	public const int minusequal_Sym = 17;
	public const int plusequal_Sym = 18;
	public const int starequal_Sym = 19;
	public const int slashequal_Sym = 20;
	public const int lbrack_Sym = 21;
	public const int rbrack_Sym = 22;
	public const int if_Sym = 23;
	public const int elsif_Sym = 24;
	public const int else_Sym = 25;
	public const int while_Sym = 26;
	public const int do_Sym = 27;
	public const int for_Sym = 28;
	public const int to_Sym = 29;
	public const int downto_Sym = 30;
	...
	public const int write_Sym = 36;
	public const int plus_Sym = 37;
	public const int minus_Sym = 38;
	public const int new_Sym = 39;
	public const int bang_Sym = 40;
	public const int lbrackrbrack_Sym = 41;
	public const int int_Sym = 42;
	public const int bool_Sym = 43;
	public const int barbar_Sym = 44;
	public const int star_Sym = 45;
	public const int slash_Sym = 46;
	...
	static bool[,] set = {
		...
		{x,T,x,x, x,x,x,x, T,x,T,T, x,x,x,x, x,x,x,x, x,x,x,T, x,x,T,T, T,x,x,T, T,T,T,T, T,x,x,x, x,x,T,T, x,x,x,x, x,x,x,x, x,x,x,x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,T, T,T,x,x},
		{x,T,T,x, T,x,T,x, x,x,x,x, x,x,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x},
...
public class Errors {
	...
	public static void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 57: s = "invalid ForStatement"; break;
			case 58: s = "invalid Constant"; break;
			case 59: s = "invalid ReadElement"; break;
			case 60: s = "invalid WriteElement"; break;
