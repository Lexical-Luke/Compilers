...
public class Scanner {
	...
	const int if_Sym = 22;
	const int then_Sym = 23;
	const int else_Sym = 24;
	const int while_Sym = 25;
	const int repeat_Sym = 26;
	const int until_Sym = 27;
	const int halt_Sym = 28;
	const int return_Sym = 29;
	const int break_Sym = 30;
	...
	const int new_Sym = 40;
	const int star_Sym = 41;
	const int slash_Sym = 42;
	const int percent_Sym = 43;
	const int equalequal_Sym = 44;
	const int bangequal_Sym = 45;
	const int lessgreater_Sym = 46;
	...
	const int colonequal_Sym = 52;
	const int NOT_SYM = 53;
	// pragmas
	const int CodFileOn_Sym = 54;
	const int CodFileOff_Sym = 55;
	...
	static void CheckLiteral() {
		switch (t.val) {
			...
			case "then": t.kind = then_Sym; break;
	...
	static Token NextToken() {
		...
		switch (state) {
			...
			case 11:
				{ t.kind = CodFileOn_Sym; goto done; }
			case 12:
				{ t.kind = CodFileOff_Sym; goto done; }
			case 13:
			...
			case 42:
				{ t.kind = lessgreater_Sym; goto done; }
			case 43:
			...
			case 46:
				{ t.kind = colonequal_Sym; goto done; }
			case 47:
