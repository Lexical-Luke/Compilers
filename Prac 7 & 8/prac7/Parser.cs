...
public class Parser {
	...
	public const int repeat_Sym = 26;
	public const int until_Sym = 27;
	public const int halt_Sym = 28;
	public const int return_Sym = 29;
	public const int break_Sym = 30;
	...
	public const int new_Sym = 40;
	public const int star_Sym = 41;
	public const int slash_Sym = 42;
	public const int percent_Sym = 43;
	public const int equalequal_Sym = 44;
	public const int bangequal_Sym = 45;
	public const int lessgreater_Sym = 46;
	public const int equal_Sym = 47;
	public const int less_Sym = 48;
	public const int lessequal_Sym = 49;
	public const int greater_Sym = 50;
	public const int greaterequal_Sym = 51;
	public const int colonequal_Sym = 52;
	public const int NOT_SYM = 53;
	// pragmas
	public const int CodFileOn_Sym = 54;
	public const int CodFileOff_Sym = 55;
	...
	public const int _CodFileOn = 54;
	public const int _CodFileOff = 55;
...
/* -------------------------------------------------------- */
	...
	static void Get () {
		for (;;) {
			...
			if (la.kind <= maxT) { ++errDist; break; }
				if (la.kind == CodFileOn_Sym) {
				listCode  = true;
				}
				if (la.kind == CodFileOff_Sym) {
				listCode  = false;
				}
	...
	static void Statement(StackFrame frame, Label loopExit = null) {
		while (!(StartOf(3))) {SynErr(54); Get();}
		switch (la.kind) {
		case lbrace_Sym: {
			Block(frame, loopExit);
			break;
		}
		case const_Sym: {
			ConstDeclarations();
	...
	static void Block(StackFrame frame, Label loopExit) {
		Table.OpenScope();
		Expect(lbrace_Sym);
		while (StartOf(1)) {
	...
	static void IfStatement(StackFrame frame, Label loopExit) {
		...
		if (la.kind == then_Sym) {
			Get();
			Warning("'then' was found in if statement");
		}
		CodeGen.BranchFalse(falseLabel);
		Statement(frame, loopExit);
	...
	static void HaltStatement() {
		...
		Expect(rparen_Sym);
		CodeGen.WriteLine(); CodeGen.LeaveProgram();
		ExpectWeak(semicolon_Sym, 4);
	}
	...
	static void BreakStatement(Label loopExit) {
		Expect(break_Sym);
		ExpectWeak(semicolon_Sym, 4);
	...
	static bool[,] set = {
		{T,T,x,x, x,x,x,x, T,x,T,T, x,x,x,x, x,T,T,T, x,x,T,x, x,T,T,x, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,T,x,x, x,x,x,x, T,x,T,T, x,x,x,x, x,T,T,T, x,x,T,x, x,T,T,x, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{T,T,x,x, x,T,x,x, T,x,T,T, x,x,x,x, x,T,T,T, x,x,T,x, x,T,T,x, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{T,T,x,x, x,x,x,x, T,x,T,T, x,x,x,x, x,T,T,T, x,x,T,x, x,T,T,x, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{T,T,x,x, x,x,x,x, T,T,T,T, x,x,x,x, x,T,T,T, x,x,T,x, T,T,T,T, T,T,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,T,T,T, T,x,T,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,T,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,T,T,x, T,x,T,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,T, x,x,x,x, x,x,x},
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,T, x,x,x},
		{x,T,T,x, T,x,T,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x},
		{x,x,T,x, T,x,x,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x}
...
public class Errors {
	...
	public static void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 26: s = "\"repeat\" expected"; break;
			case 27: s = "\"until\" expected"; break;
			...
			case 54: s = "this symbol not expected in Statement"; break;
			case 55: s = "invalid Statement"; break;
			case 56: s = "invalid ReadStatement"; break;
			case 57: s = "invalid WriteStatement"; break;
			case 58: s = "invalid AssignOp"; break;
			case 59: s = "invalid Constant"; break;
			case 60: s = "invalid BasicType"; break;
			case 61: s = "invalid ReadElement"; break;
			case 62: s = "invalid WriteElement"; break;
			case 63: s = "invalid EqualOp"; break;
			case 64: s = "invalid RelOp"; break;
			case 65: s = "invalid AddOp"; break;
			case 66: s = "invalid Factor"; break;
			case 67: s = "invalid MulOp"; break;
