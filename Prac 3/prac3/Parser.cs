...
public class Parser {
	...
	public const int _decNumber = 1;
	public const int _hexNumber = 2;
	// terminals
	public const int EOF_SYM = 0;
	public const int decNumber_Sym = 1;
	public const int hexNumber_Sym = 2;
	public const int equal_Sym = 3;
	public const int plus_Sym = 4;
	public const int minus_Sym = 5;
	public const int star_Sym = 6;
	public const int slash_Sym = 7;
	public const int uparrow_Sym = 8;
	public const int lparen_Sym = 9;
	public const int rparen_Sym = 10;
	public const int sqrt_Sym = 11;
	...
	static void Term() {
		Factor();
		while (la.kind == star_Sym || la.kind == slash_Sym || la.kind == uparrow_Sym) {
			if (la.kind == star_Sym) {
				Get();
				Factor();
